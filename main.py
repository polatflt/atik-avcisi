...
class AtikAvcisiUI(FloatLayout):
    ...
    def _giris_paneli(self):
        ...
        panel.add_widget(etiket(
            "Kamaray ac, atigi goster — AI otomatik taniyacak.",
    ...
    def _ai_kabul(self, tur, guven):
        """AI motorunun tespit ettigi atigi kaydeder."""
    ...
    def _kaydet(self, tur, miktar=1):
        """AI tarafindan tespit edilen atigi kaydet."""
    ...
    def _popup(self, baslik, mesaj):
        ...
        with icerik.canvas.before:
            ...
            _bg = Rectangle(pos=icerik.pos, size=icerik.size)

        def _guncelle_bg(widget, _value):
            _bg.pos  = widget.pos
            _bg.size = widget.size

        icerik.bind(pos=_guncelle_bg, size=_guncelle_bg)
